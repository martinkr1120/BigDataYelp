...
public class IndexBusinessDetailRunner {

  public static void main(String[] args) throws Exception {
    JobConf countReviewTipMapperConf = new JobConf(IndexBusinessDetailRunner.class);
    
    Path inPath = new Path("input","yelp_academic_dataset_business.json");
    Path outPath = new Path("output","businessDetail");
    
    try {
      /*
       * Graph Builder JobConf
       */
      countReviewTipMapperConf.setJobName("Build businessDetail");
      countReviewTipMapperConf.setMapperClass(IndexBusinessDetailMapper.class);
